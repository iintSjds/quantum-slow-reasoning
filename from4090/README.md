...
|-------------------------|--------|----------|
| `grover_sweep/`         | 175 MB | main N=120 sliding-puzzle sweep, 8 seeds x B: Grover-n=1..4 coin walkers, one-shot / best-of-k / capped / entropy classical controls, semi (measured-walk) controls |
